...
**目标地面范围（代码中的 target window）**回答：“为了当前任务，我们希望 BirdView
重点装下哪一块地面？”
...
这比用“看起来连通”作 hard gate 更直接。测试知道自己没验什么，和知道自己验了什么
同样重要。
